            ...
            Try
                ...
                If Salir = 0 Then
                    Try
                        ...
                        Dim Command As New SqlCommand("Exec addPlato '" & txtrandom.Text & "','" & txtNombre.Text & "','" & TxtDesEsp.Text & "','" & CombCate.SelectedItem.ToString & "','" & CombComida.SelectedItem.ToString & "','" & txtPrecio.Text & "','" & txtCal.Text & "','" & txtDesIng.Text & "';", Conn)
                        Dim Adapter As New SqlDataAdapter(Command)
                        Adapter.Fill(Table)
                ...
                If Salir = 1 Then
                    ...
                    Try
                        Dim Command As New SqlCommand("insert into FotosMenu(CodPlato,Nombre,Foto) values(@Cod,@Nom,@Foto)", Conn)
